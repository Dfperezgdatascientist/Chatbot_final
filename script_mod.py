...
Original file is located at
    https://colab.research.google.com/drive/1K5GnKVtp9qZCFaGCYQ4mRuEoFkMVjRVx
...
#batch_size = 15
#epochs = 1000#600
num_encoder_tokens = 604
num_decoder_tokens = 830
#Encoder
encoder_inputs = Input(shape=(None, 604))
...
from keras.models import load_model
entrenamiento ='/content/drive/Shareddrives/Chat Bot/2. Modelo Seq2Seq y chatbot/Modelo/training_model.hdf5'
...
#      reply = input(self.generate_response(reply)+"\n")
  ...
  def string_to_matrix(self, user_input):
    ...
    user_input_matrix = np.zeros((1, 19, 604), #max_encoder_seq_length, num_encoder_tokens
      dtype='float32')
